...
const MUNICIPAL_NAME_ALIASES = {
  ...
  AMAPARI: ['AMAPARI', 'PEDRA_BRANCA_DO_AMAPARI', 'PEDRA_BRANCA', 'PEDRA_BRANCA_AMAPARI', 'AGUA_BRANCA_DO_AMAPARI'],
  ...
  NOVA_BRASILANDIA: ['NOVA_BRASILANDIA', 'NOVA_BRASILANDIA_DO_OESTE', 'NOVA_BRASILANDIA_D_OESTE', 'NOVA_BRASILANDIA_DOESTE'],
  NOVA_BRASILANDIA_DO_OESTE: ['NOVA_BRASILANDIA', 'NOVA_BRASILANDIA_DO_OESTE', 'NOVA_BRASILANDIA_D_OESTE', 'NOVA_BRASILANDIA_DOESTE'],
  NOVA_BRASILANDIA_D_OESTE: ['NOVA_BRASILANDIA', 'NOVA_BRASILANDIA_DO_OESTE', 'NOVA_BRASILANDIA_D_OESTE', 'NOVA_BRASILANDIA_DOESTE'],
  NOVA_BRASILANDIA_DOESTE: ['NOVA_BRASILANDIA', 'NOVA_BRASILANDIA_DO_OESTE', 'NOVA_BRASILANDIA_D_OESTE', 'NOVA_BRASILANDIA_DOESTE'],
  PARATI: ['PARATY', 'PARATI'],
  PARATY: ['PARATY', 'PARATI'],
  PEDRA_BRANCA: ['AMAPARI', 'PEDRA_BRANCA_DO_AMAPARI', 'PEDRA_BRANCA', 'PEDRA_BRANCA_AMAPARI', 'AGUA_BRANCA_DO_AMAPARI'],
  PEDRA_BRANCA_DO_AMAPARI: ['AMAPARI', 'PEDRA_BRANCA_DO_AMAPARI', 'PEDRA_BRANCA', 'PEDRA_BRANCA_AMAPARI', 'AGUA_BRANCA_DO_AMAPARI'],
  PEDRA_BRANCA_AMAPARI: ['AMAPARI', 'PEDRA_BRANCA_DO_AMAPARI', 'PEDRA_BRANCA', 'PEDRA_BRANCA_AMAPARI', 'AGUA_BRANCA_DO_AMAPARI'],
  AGUA_BRANCA_DO_AMAPARI: ['AMAPARI', 'PEDRA_BRANCA_DO_AMAPARI', 'PEDRA_BRANCA', 'PEDRA_BRANCA_AMAPARI', 'AGUA_BRANCA_DO_AMAPARI'],
  ...
  ARMACAO_DE_BUZIOS: ['ARMACAO_DOS_BUZIOS', 'ARMACAO_DE_BUZIOS'],
  ARMACAO_DOS_BUZIOS: ['ARMACAO_DOS_BUZIOS', 'ARMACAO_DE_BUZIOS'],
  CAMPOS: ['CAMPOS_DOS_GOYTACAZES', 'CAMPOS'],
  CAMPOS_DOS_GOYTACAZES: ['CAMPOS_DOS_GOYTACAZES', 'CAMPOS'],
  PATI_DO_ALFERES: ['PATY_DO_ALFERES', 'PATI_DO_ALFERES'],
  PATY_DO_ALFERES: ['PATY_DO_ALFERES', 'PATI_DO_ALFERES'],
  VARRE_E_SAI: ['VARRE_SAI', 'VARRE_E_SAI'],
  VARRE_SAI: ['VARRE_SAI', 'VARRE_E_SAI'],
  // ── 2000/2004 TSE name aliases ──────────────────────────────────────────────
  // AL: "Teotônio Vilela" appears as SENADOR_TEOTONIO_VILELA in the TSE data
  TEOTONIO_VILELA: ['SENADOR_TEOTONIO_VILELA', 'TEOTONIO_VILELA'],
  SENADOR_TEOTONIO_VILELA: ['SENADOR_TEOTONIO_VILELA', 'TEOTONIO_VILELA'],
  // AM: "Novo Airão" appears as NOVO_AYRAO in the TSE data
  NOVO_AIRAO: ['NOVO_AIRAO', 'NOVO_AYRAO'],
  NOVO_AYRAO: ['NOVO_AIRAO', 'NOVO_AYRAO'],
  // CE: "Catunda" appears as SENADOR_CATUNDA; "Deputado Irapuan Pinheiro" as DEP_IRAPUAN_PINHEIRO; "Granjeiro" as GRANGEIRO
  CATUNDA: ['SENADOR_CATUNDA', 'CATUNDA'],
  SENADOR_CATUNDA: ['SENADOR_CATUNDA', 'CATUNDA'],
  DEPUTADO_IRAPUAN_PINHEIRO: ['DEP_IRAPUAN_PINHEIRO', 'DEPUTADO_IRAPUAN_PINHEIRO'],
  DEP_IRAPUAN_PINHEIRO: ['DEP_IRAPUAN_PINHEIRO', 'DEPUTADO_IRAPUAN_PINHEIRO'],
  GRANJEIRO: ['GRANGEIRO', 'GRANJEIRO'],
  GRANGEIRO: ['GRANGEIRO', 'GRANJEIRO'],
  // ES: "São Domingos do Norte" appears as SAO_DOMINGOS in TSE 2000 data
  // Note: TSE stored this differently from PB's SAO_DOMINGOS_DE_POMBAL above.
  // SAO_DOMINGOS_DO_NORTE maps to SAO_DOMINGOS; the reverse alias is not added
  // to avoid overwriting the existing SAO_DOMINGOS → SAO_DOMINGOS_DE_POMBAL (PB).
  SAO_DOMINGOS_DO_NORTE: ['SAO_DOMINGOS_DO_NORTE', 'SAO_DOMINGOS'],

  // GO: "Alto Paraíso de Goiás" → ALTO_PARAISO; "Bom Jesus de Goiás" → BOM_JESUS; "Mundo Novo" → MUNDO_NOVO_DE_GOIAS
  ALTO_PARAISO_DE_GOIAS: ['ALTO_PARAISO', 'ALTO_PARAISO_DE_GOIAS'],
  ALTO_PARAISO: ['ALTO_PARAISO', 'ALTO_PARAISO_DE_GOIAS', 'VILA_ALTA'],
  BOM_JESUS_DE_GOIAS: ['BOM_JESUS', 'BOM_JESUS_DE_GOIAS'],
  BOM_JESUS: ['BOM_JESUS', 'BOM_JESUS_DE_GOIAS'],
  MUNDO_NOVO: ['MUNDO_NOVO', 'MUNDO_NOVO_DE_GOIAS'],
  MUNDO_NOVO_DE_GOIAS: ['MUNDO_NOVO', 'MUNDO_NOVO_DE_GOIAS'],
  // MG: apostrophes stripped differently, "Conceição das Pedras" → CONCEICAO_DA_PEDRA
  OLHOS_DAGUA: ['OLHOS_DAGUA', 'OLHOS_D_AGUA'],
  OLHOS_D_AGUA: ['OLHOS_DAGUA', 'OLHOS_D_AGUA'],
  PINGO_DAGUA: ['PINGO_DAGUA', 'PINGO_D_AGUA'],
  PINGO_D_AGUA: ['PINGO_DAGUA', 'PINGO_D_AGUA'],
  CONCEICAO_DAS_PEDRAS: ['CONCEICAO_DA_PEDRA', 'CONCEICAO_DAS_PEDRAS'],
  CONCEICAO_DA_PEDRA: ['CONCEICAO_DA_PEDRA', 'CONCEICAO_DAS_PEDRAS'],
  // MG: "Itabirinha" appears as ITABIRINHA_DE_MANTENA in TSE data
  ITABIRINHA: ['ITABIRINHA', 'ITABIRINHA_DE_MANTENA'],
  ITABIRINHA_DE_MANTENA: ['ITABIRINHA', 'ITABIRINHA_DE_MANTENA'],
  // MS: spelling differences for Aparecida do Taboado, Bataguassu, Batayporã, Juti
  APARECIDA_DO_TABOADO: ['APARECIDA_DO_TABUADO', 'APARECIDA_DO_TABOADO'],
  APARECIDA_DO_TABUADO: ['APARECIDA_DO_TABUADO', 'APARECIDA_DO_TABOADO'],
  BATAGUASSU: ['BATAGUACU', 'BATAGUASSU'],
  BATAGUACU: ['BATAGUACU', 'BATAGUASSU'],
  BATAYPORA: ['BATAIPORA', 'BATAYPORA'],
  BATAIPORA: ['BATAIPORA', 'BATAYPORA'],
  JUTI: ['JUTY', 'JUTI'],
  JUTY: ['JUTY', 'JUTI'],
  // PB: "Baraúna" appears as BARAUNAS; "São Sebastião da Lagoa da Roça" → SAO_SEB_DE_LAGOA_DE_ROCA;
  //     "Santa Cecília" → SANTA_CECILIA_DE_UMBUZEIRO
  BARAUNA: ['BARAUNAS', 'BARAUNA'],
  BARAUNAS: ['BARAUNAS', 'BARAUNA'],
  SAO_SEBASTIAO_DA_LAGOA_DA_ROCA: ['SAO_SEB_DE_LAGOA_DE_ROCA', 'SAO_SEBASTIAO_DA_LAGOA_DA_ROCA', 'SAO_SEBASTIAO_DE_LAGOA_DE_ROCA'],
  SAO_SEB_DE_LAGOA_DE_ROCA: ['SAO_SEB_DE_LAGOA_DE_ROCA', 'SAO_SEBASTIAO_DA_LAGOA_DA_ROCA', 'SAO_SEBASTIAO_DE_LAGOA_DE_ROCA'],
  SAO_SEBASTIAO_DE_LAGOA_DE_ROCA: ['SAO_SEB_DE_LAGOA_DE_ROCA', 'SAO_SEBASTIAO_DA_LAGOA_DA_ROCA', 'SAO_SEBASTIAO_DE_LAGOA_DE_ROCA'],
  SANTA_CECILIA: ['SANTA_CECILIA_DE_UMBUZEIRO', 'SANTA_CECILIA'],
  SANTA_CECILIA_DE_UMBUZEIRO: ['SANTA_CECILIA_DE_UMBUZEIRO', 'SANTA_CECILIA'],
  // PE: "Jaboatão dos Guararapes" → JABOATAO; "Cabo de Santo Agostinho" → CABO; "São Caitano" → SAO_CAETANO
  JABOATAO_DOS_GUARARAPES: ['JABOATAO', 'JABOATAO_DOS_GUARARAPES'],
  JABOATAO: ['JABOATAO', 'JABOATAO_DOS_GUARARAPES'],
  CABO_DE_SANTO_AGOSTINHO: ['CABO', 'CABO_DE_SANTO_AGOSTINHO'],
  SAO_CAITANO: ['SAO_CAETANO', 'SAO_CAITANO'],
  SAO_CAETANO: ['SAO_CAETANO', 'SAO_CAITANO'],
  // PI: "Pau d'Arco do Piauí" → PAU_DARCO_DO_PIAUI; "Alagoinha do Piauí" → ALAGOINHA
  PAU_DARCO_DO_PIAUI: ['PAU_DARCO_DO_PIAUI', 'PAU_D_ARCO_DO_PIAUI'],
  PAU_D_ARCO_DO_PIAUI: ['PAU_DARCO_DO_PIAUI', 'PAU_D_ARCO_DO_PIAUI'],
  ALAGOINHA_DO_PIAUI: ['ALAGOINHA', 'ALAGOINHA_DO_PIAUI'],
  ALAGOINHA: ['ALAGOINHA', 'ALAGOINHA_DO_PIAUI'],
  // PR: "Conselheiro Mairinck" → CONSELHEIRO_MAYRINCK; "Santa Isabel do Ivaí" → SANTA_IZABEL_DO_IVAI;
  //     "Santana do Itararé" → SANTA_ANA_DO_ITARARE; "Alto Paraíso" (PR) → VILA_ALTA;
  //     "Luiziana" → LUISIANIA; "Moreira Sales" → MOREIRA_SALLES
  CONSELHEIRO_MAIRINCK: ['CONSELHEIRO_MAYRINCK', 'CONSELHEIRO_MAIRINCK'],
  CONSELHEIRO_MAYRINCK: ['CONSELHEIRO_MAYRINCK', 'CONSELHEIRO_MAIRINCK'],
  SANTA_ISABEL_DO_IVAI: ['SANTA_IZABEL_DO_IVAI', 'SANTA_ISABEL_DO_IVAI'],
  SANTA_IZABEL_DO_IVAI: ['SANTA_IZABEL_DO_IVAI', 'SANTA_ISABEL_DO_IVAI'],
  SANTANA_DO_ITARARE: ['SANTA_ANA_DO_ITARARE', 'SANTANA_DO_ITARARE'],
  SANTA_ANA_DO_ITARARE: ['SANTA_ANA_DO_ITARARE', 'SANTANA_DO_ITARARE'],
  VILA_ALTA: ['ALTO_PARAISO', 'ALTO_PARAISO_DE_GOIAS', 'VILA_ALTA'],
  LUIZIANA: ['LUISIANIA', 'LUIZIANA'],
  LUISIANIA: ['LUISIANIA', 'LUIZIANA'],
  MOREIRA_SALES: ['MOREIRA_SALLES', 'MOREIRA_SALES'],
  MOREIRA_SALLES: ['MOREIRA_SALLES', 'MOREIRA_SALES'],
  // RN: "Fernando Pedroza" → FERNANDO_PEDROSA; "São Miguel do Gostoso" → SAO_MIGUEL_DE_TOUROS;
  //     "Serra Caiada" → PRESIDENTE_JUSCELINO (in 2000) or SERRA_CAIADA (in 2004)
  FERNANDO_PEDROZA: ['FERNANDO_PEDROSA', 'FERNANDO_PEDROZA'],
  FERNANDO_PEDROSA: ['FERNANDO_PEDROSA', 'FERNANDO_PEDROZA'],
  SAO_MIGUEL_DO_GOSTOSO: ['SAO_MIGUEL_DE_TOUROS', 'SAO_MIGUEL_DO_GOSTOSO'],
  SAO_MIGUEL_DE_TOUROS: ['SAO_MIGUEL_DE_TOUROS', 'SAO_MIGUEL_DO_GOSTOSO'],
  SERRA_CAIADA: ['PRESIDENTE_JUSCELINO', 'SERRA_CAIADA'],
  PRESIDENTE_JUSCELINO: ['PRESIDENTE_JUSCELINO', 'SERRA_CAIADA'],

  // RS: "Trindade do Sul" → TRINDADE; "Chiapetta" → CHIAPETA; "São Luiz Gonzaga" → SAO_LUIS_GONZAGA
  TRINDADE_DO_SUL: ['TRINDADE', 'TRINDADE_DO_SUL'],
  CHIAPETTA: ['CHIAPETA', 'CHIAPETTA'],
  CHIAPETA: ['CHIAPETA', 'CHIAPETTA'],
  SAO_LUIZ_GONZAGA: ['SAO_LUIS_GONZAGA', 'SAO_LUIZ_GONZAGA'],
  SAO_LUIS_GONZAGA: ['SAO_LUIS_GONZAGA', 'SAO_LUIZ_GONZAGA'],
  // SC: "Balneário Piçarras" → PICARRAS; "Lajeado Grande" → LAGEADO_GRANDE
  BALNEARIO_PICARRAS: ['PICARRAS', 'BALNEARIO_PICARRAS'],
  PICARRAS: ['PICARRAS', 'BALNEARIO_PICARRAS'],
  LAJEADO_GRANDE: ['LAGEADO_GRANDE', 'LAJEADO_GRANDE'],
  LAGEADO_GRANDE: ['LAGEADO_GRANDE', 'LAJEADO_GRANDE'],
  // SP: "Mogi Guaçu" → MOJI_GUACU; "Pirassununga" → PIRACUNUNGA; "Bernardino de Campos" → BERNADINO_DE_CAMPOS;
  //     "Valparaíso" → VALPARAIZO; "Sud Mennucci" → SUD_MENUCCI; "Suzanápolis" → SUZANOPOLIS;
  //     "Ipaussu" → IPAUCU; "Luiziânia" → LUISIANIA; "Salmourão" → SALMORAO; "Bady Bassitt" → BADY_BASSIT
  MOGI_GUACU: ['MOJI_GUACU', 'MOGI_GUACU'],
  MOJI_GUACU: ['MOJI_GUACU', 'MOGI_GUACU'],
  PIRASSUNUNGA: ['PIRACUNUNGA', 'PIRASSUNUNGA'],
  PIRACUNUNGA: ['PIRACUNUNGA', 'PIRASSUNUNGA'],
  BERNARDINO_DE_CAMPOS: ['BERNADINO_DE_CAMPOS', 'BERNARDINO_DE_CAMPOS'],
  BERNADINO_DE_CAMPOS: ['BERNADINO_DE_CAMPOS', 'BERNARDINO_DE_CAMPOS'],
  VALPARAISO: ['VALPARAIZO', 'VALPARAISO'],
  VALPARAIZO: ['VALPARAIZO', 'VALPARAISO'],
  SUD_MENNUCCI: ['SUD_MENUCCI', 'SUD_MENNUCCI'],
  SUD_MENUCCI: ['SUD_MENUCCI', 'SUD_MENNUCCI'],
  SUZANAPOLIS: ['SUZANOPOLIS', 'SUZANAPOLIS'],
  SUZANOPOLIS: ['SUZANOPOLIS', 'SUZANAPOLIS'],
  IPAUSSU: ['IPAUCU', 'IPAUSSU'],
  IPAUCU: ['IPAUCU', 'IPAUSSU'],
  LUIZIANIA: ['LUISIANIA', 'LUIZIANIA'],
  LUISIANIA: ['LUISIANIA', 'LUIZIANIA'],
  SALMOURAO: ['SALMORAO', 'SALMOURAO'],
  SALMORAO: ['SALMORAO', 'SALMOURAO'],
  BADY_BASSITT: ['BADY_BASSIT', 'BADY_BASSITT'],
  BADY_BASSIT: ['BADY_BASSIT', 'BADY_BASSITT'],
  // BA: "Santa Terezinha" → SANTA_TERESINHA; "Érico Cardoso" → AGUA_QUENTE; "Pindaí" → OURO_BRANCO; "Caém" → ANSELMO_DA_FONSECA
  SANTA_TEREZINHA: ['SANTA_TERESINHA', 'SANTA_TEREZINHA'],
  SANTA_TERESINHA: ['SANTA_TERESINHA', 'SANTA_TEREZINHA'],
  ERICO_CARDOSO: ['AGUA_QUENTE', 'ERICO_CARDOSO'],
  AGUA_QUENTE: ['AGUA_QUENTE', 'ERICO_CARDOSO'],
  PINDAI: ['OURO_BRANCO', 'PINDAI'],
  OURO_BRANCO: ['OURO_BRANCO', 'PINDAI'],
  CAEM: ['ANSELMO_DA_FONSECA', 'CAEM'],
  ANSELMO_DA_FONSECA: ['ANSELMO_DA_FONSECA', 'CAEM'],
  // MG: "Gouveia" appears as GOUVEA (missing 'i') in TSE data
  GOUVEIA: ['GOUVEA', 'GOUVEIA'],
  GOUVEA: ['GOUVEA', 'GOUVEIA'],
  // AC: "Manoel Urbano" → MANUEL_URBANO; "Santa Rosa do Purus" → SANTA_ROSA
  MANOEL_URBANO: ['MANUEL_URBANO', 'MANOEL_URBANO'],
  MANUEL_URBANO: ['MANUEL_URBANO', 'MANOEL_URBANO'],
  SANTA_ROSA_DO_PURUS: ['SANTA_ROSA', 'SANTA_ROSA_DO_PURUS'],
  SANTA_ROSA: ['SANTA_ROSA', 'SANTA_ROSA_DO_PURUS']
};
    ...
    const loadTurnEntries = async (turno) => {
      ...
      try {
        ...
        for (const entryName of entryNames) {
          ...
          const payload = JSON.parse(await readBlobAsText(blobData));
...
function buildVereadorOfficialSummary(fullJson) {
  // Totais COMPLETOS embutidos (2000/2004 — inclui secoes sem geolocalizacao e
  // municipios inteiros do munzona). Senao, soma o que esta geolocalizado.
  const embedded = fullJson?.METADATA?.official_votes;
  const rawTotals = (embedded && Object.keys(embedded).length)
    ? embedded
    : aggregateVotesFromResults(fullJson?.RESULTS || {});
  return {
    votesById: rawTotals,
