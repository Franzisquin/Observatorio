...
(function () {
  ...
  var DICT = {
    pt: {
      ...
      'home.f3.title': 'Agregador de pesquisas',
      'home.f3.desc': 'Pesquisas eleitorais compiladas e ponderadas, com médias móveis e leitura de tendência.',
      ...
      'br.t3.title': 'Agregador de Pesquisas',
      'br.t3.desc': 'Pesquisas compiladas e ponderadas, com médias móveis e visualização de tendências.',
      'br.t4.title': 'Nowcast',
    ...
    en: {
      ...
      'home.f3.title': 'Poll aggregator',
      'home.f3.desc': 'Election polls compiled and weighted, with moving averages and trend reading.',
      'home.f4.title': 'Nowcast',
      ...
      'br.t3.title': 'Poll Aggregator',
      'br.t3.desc': 'Polls compiled and weighted, with moving averages and trend visualisation.',
      'br.t4.title': 'Nowcast',
